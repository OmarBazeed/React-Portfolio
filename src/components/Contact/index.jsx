      ...
      <div className="ContactPage">
        <div className="Contact-content">
          <div className="first">
            ...
            <p>
              i'm intersted in freelance oppertunities - especially ambitious or
          ...
          <div className="the-map">
            <MapContainer center={position} zoom={13} scrollWheelZoom={true}>
              ...
              <Marker position={position}>
                <Popup>
                  unfortunately, need to pay to get my right location So I live
                  In Mansoura Search For It , Come To Have Some Coffee !!
                </Popup>
              </Marker>
            </MapContainer>
          </div>
